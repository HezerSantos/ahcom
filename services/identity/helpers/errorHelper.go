...
func NetworkError(c *gin.Context, errorMessage string) {
	fmt.Printf("ERROR OCCURED: %s", errorMessage)
	c.JSON(500, gin.H{
...
func AuthError(c *gin.Context, errorMessage string) {
	fmt.Printf("ERROR OCCURED: %s", errorMessage)
	c.JSON(401, gin.H{
...
func BadRequestBodyError(c *gin.Context, errorMessage string) {
	fmt.Printf("ERROR OCCURED: %s", errorMessage)
	c.JSON(400, gin.H{
...
func BadRequestParamsError(c *gin.Context, errorMessage string) {
	fmt.Printf("ERROR OCCURED: %s", errorMessage)
	c.JSON(400, gin.H{
...
func BadRequestQueryError(c *gin.Context, errorMessage string) {
	fmt.Printf("ERROR OCCURED: %s", errorMessage)
	c.JSON(400, gin.H{
...
func ForbiddenError(c *gin.Context, errorMessage string) {
	fmt.Printf("ERROR OCCURED: %s", errorMessage)
	c.JSON(403, gin.H{
